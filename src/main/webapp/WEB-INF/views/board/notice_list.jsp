...
$(document).ready(function(){   
   ...
   $('.page-link').click(function(){
      location.replace('/notice_list/2')
   });
});
</script>
<body>
<header class="navbar   head_wrap  ">
               ...
               <div class="container px-0 pt-xl-2">
                  <div>
                  <a href="/notice_list"  class="btn svg  p-0" alt="로고">
                     <object  class="d-block logo" type="image/svg+xml" data="img/logo.svg"></object></a>
                  </div>
                  
                  <div><a href="https://dmonster1629.cafe24.com/design2/mypage.html"   class="topmenu_ico"> <i class="xi-profile-o xi-2x xi-x"></i> <span class="d-none d-lg-inline-block d-xl-inline-block">${user_id}</a><!-- 마이페이지 -->
